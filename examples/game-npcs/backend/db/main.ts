...
function initNPCs() {
  ...
  INSERT INTO npc (name, height, mass, hairColor, skinColor, eyeColor, gender, voice, audioShift, description, relations)
  VALUES ($name, $height, $mass, $hairColor, $skinColor, $eyeColor, $gender, $voice, $audioShift, $description, $relations)
`);
